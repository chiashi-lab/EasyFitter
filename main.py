...
class EasyFitter(tk.Frame):
    ...
    def create_widgets(self):
        ...
        label_baseline_name.grid(row=1000, column=0)
        self.entry_baseline_a.grid(row=1000, column=1)
        label_x.grid(row=1000, column=2)
        self.entry_baseline_b.grid(row=1000, column=3)
        button_add_peak.grid(row=1001, column=0, columnspan=3)
        button_fit.grid(row=1001, column=3, columnspan=2)
